...
class HcOneInner():
    ...
    def DetectInner(self):
        ...
        #cv2.imwrite("bkackmask.jpg",black_mask)
        ...
        cv2.imwrite("bkackmask.jpg",black_mask)
        circles = cv2.HoughCircles(black_mask, cv2.HOUGH_GRADIENT, dp=1, minDist=30, param1=50, param2=30, minRadius=5, maxRadius=900)
...
obj = HcOneInner("images/current.jpg")
res = obj.DetectInner()
print(res)
